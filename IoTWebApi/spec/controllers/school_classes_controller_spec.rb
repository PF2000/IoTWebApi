...
RSpec.describe SchoolClassesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested school_class as @school_class" do
      school_class = SchoolClass.create! valid_attributes
      get :show, params: {id: school_class.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested school_class as @school_class" do
      school_class = SchoolClass.create! valid_attributes
      get :edit, params: {id: school_class.to_param}, session: valid_session
      expect(assigns(:school_class)).to eq(school_class)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SchoolClass" do
        expect {
          post :create, params: {school_class: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved school_class as @school_class" do
        post :create, params: {school_class: invalid_attributes}, session: valid_session
        expect(assigns(:school_class)).to be_a_new(SchoolClass)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested school_class" do
        school_class = SchoolClass.create! valid_attributes
        put :update, params: {id: school_class.to_param, school_class: new_attributes}, session: valid_session
        school_class.reload
      ...
      it "assigns the requested school_class as @school_class" do
        school_class = SchoolClass.create! valid_attributes
        put :update, params: {id: school_class.to_param, school_class: valid_attributes}, session: valid_session
        expect(assigns(:school_class)).to eq(school_class)
      end
    ...
    context "with invalid params" do
      it "assigns the school_class as @school_class" do
        school_class = SchoolClass.create! valid_attributes
        put :update, params: {id: school_class.to_param, school_class: invalid_attributes}, session: valid_session
        expect(assigns(:school_class)).to eq(school_class)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested school_class" do
      school_class = SchoolClass.create! valid_attributes
      expect {
        delete :destroy, params: {id: school_class.to_param}, session: valid_session
      }.to change(SchoolClass, :count).by(-1)
    end
